...
public class Enchantments {
    ...
    public static void initialize(File file) {
        ...
        poisonArrowTimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        slowArrowTimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        witherArrowTimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        poisonAspectTimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        slowAspectTimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        witherAspectTimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        poisonAOETimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        slowAOETimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        witherAOETimer = getInt(POISON, "Poison Arrow Timer in seconds", 50);
        ...
        Property WisdomMax = get(MAX, "Wisdom", 50);
        Property SwiftnessMax = get(MAX, "Swiftness", 50);
        Property PoisonAspectMax = get(MAX, "PoisonAspect", 5);
        Property AntiVenomMax = get(MAX, "AntiVenom", 3);
        Property RegenerationMax = get(MAX, "Regeneration dont change", 1);
        Property HighJumpMax = get(MAX, "HighJump", 50);
        Property LethargyMax = get(MAX, "Lethargy", 50);
        Property QuickDrawMax = get(MAX, "QuickDraw", 50);
        ...
        Property VerticallyMax = get(MAX, "Vertically", 50);
        ...
        Property WitherArrowMax = get(MAX, "WitherArrow", 5);
        Property WitherAspectMax = get(MAX, "WitherAspect", 5);
        Property WitherArrowAoeMax = get(MAX, "WitherArrowAoe", 5);
        Property SharpShooterMax = get(MAX, "SharpShooter dont change", 1);
        Property GreenWoodMax = get(MAX, "GreenWood dont change", 1);
        Property DisarmMax = get(MAX, "Disarm", 50);
